! function (e, t) {
    ...
    return function (e) {
            ...
            var l = function () {
                ...
                return o(e, [{
                    ...
                    value: function () {
                        var e = this,
                            t = void 0;
                        t = this.options.api.maximum ? this.options.api.address + "?oid=" + this.options.api.oid + "&max=" + this.options.api.maximum : this.options.api.address + "?oid=" + this.options.api.oid;
                        console.log(t)
       ...
       //                      $.ajax({
	      ...
	      //                       }, error: function (r) {
	      //                           n.options.error(r || n.options.tran("Danmaku load failed")), i[o] = [], ++a === e.length && t(i);
       //                         		console.log('adfadfasdfjkfdsjfksfjklsjflskjflksdjfslkjflksjflajdkfjalksjfdlksjfljsl')
